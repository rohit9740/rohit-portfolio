...
const experiences = [
  {
    ...
    emoji: "🍕",
    color: "#FF006E",
    shortBio: "I built KPI dashboards in Power BI that the product team actually started using. That felt like the right result.",
    bullets: [
    ...
    funNote: "\"Impressed\" was his word. Coming from someone precise and exacting in their standards, I took that seriously.",
    badge: "Latest Role",
  },
  {
    id: "nrc",
    ...
    funNote: "Working at the Norwegian Refugee Council was one of the more grounding experiences of my career so far. Real problems, real stakes.",
    badge: "NGO",
  },
  {
    id: "biso-impact",
    ...
    emoji: "♻️",
    color: "#8338EC",
    shortBio: "I coordinated Norway's largest student sustainability conference from the ground up. The planning alone took most of a year.",
    bullets: [
    ...
    funNote: "Norway's largest student sustainability conference, run entirely by students. A long year of planning, and watching it come together was worth every bit of it.",
    badge: "Leadership",
  },
  {
    id: "bba-board",
    ...
    emoji: "🎓",
    color: "#FFBE0B",
    shortBio: "VP of the BBA student board at BISO Oslo. Ran events, kept things moving, tried to make it count.",
    bullets: [
  ...
  },
  {
    ...
    emoji: "👥",
    color: "#3A86FF",
    shortBio: "I managed 700+ student buddy groups during what turned out to be a record intake year at BI. A lot of coordination, and I genuinely enjoyed it.",
    bullets: [
    ...
    funNote: "My PM wrote: 'It has been a privilege to work with Rohit and I am eager to see what he does next.' That one stayed with me.",
    badge: "700 People",
  },
  {
    id: "winter-games",
    ...
    emoji: "❄️",
    color: "#FB5607",
    shortBio: "I oversaw the 2.5M NOK budget for Winter Games 2022 in my first year of university. Learned a lot about financial accountability very quickly.",
    bullets: [
    ...
    funNote: "2,500,000 NOK. My first year of university. I kept the books clean, hit every deadline, and learned that financial accountability is not something you ease into.",
    badge: "2.5M NOK",
  },
];
