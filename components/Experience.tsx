...
const experiences = [
  {
    ...
    emoji: "🍕",
    color: "#FF006E",
    shortBio: "Built the KPI dashboard. People actually used it. That is the goal, right.",
    bullets: [
  ...
  },
  {
    ...
    emoji: "🌍",
    color: "#00FF87",
    shortBio: "Cleaned and analyzed data from conflict zones. Heavy work. Important work.",
    bullets: [
  ...
  },
  {
    ...
    emoji: "👥",
    color: "#3A86FF",
    shortBio: "Managed 700+ student buddies during BI's biggest ever intake. Built the admin systems from scratch because nothing existed at that scale.",
    bullets: [
  ...
  },
  {
    ...
    emoji: "❄️",
    color: "#FB5607",
    shortBio: "Oversaw a 2.5M NOK budget in my first year of university. Learned what financial accountability actually means, fast.",
    bullets: [
